...
The paper then elaborates Scherer's\todo{cite} models for emotions and Ekman's basic emotions\todo{cite}, to concretize what the different evaluation techniques, such as Self-Assessment Manikin~(SAM) and Positive And Negative Affect Schedule~(PANAS), actually measures. Which leads to a division of the methods:
\begin{itemize}
