...
experienced in more general case, or real-word scenarios.
...
our knowledge.  Specific problems were then seeded into the program, and made active only during specific tasks.  A
total of 11 tasks were completed, and of those 7 had seeded usability problems.  The same physiological data was
collected as in the first paper, so GSR, EEG, heart rate and facial features.  The techniques used for finding usability
