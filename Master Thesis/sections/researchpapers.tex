...
The primary motivation for this paper was to 
...
Arousal 3 and Valence 3 only achieved 0.660\% and 0.671\% on average, and would probably drop lower as the resolution gets higher. 
...
This can benefit the community as a whole and help companies conducting usability evaluations to perform these with higher effeciency and/or accuracy.
