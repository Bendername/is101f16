...
This paper focuses on three different areas in the HCI context. (1) General methods used for usability testing and user experience evaluation. (2) General use of sensors in HCI. (3) The use of sensors in usability- and user experience-testing.
...
Current methods mostly rely on experts and their subjective analytic abilities whilst being focused on performance-based metrics.
However some attempts has been made to automate the process of analysing the data from the usability test or user experience evaluation. 