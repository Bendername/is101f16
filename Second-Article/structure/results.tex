...
Figure x.x.x.x.\todo{THIS NEEDS REF} and Table x.x.x\todo{THIS NEEDS REF} still shows that even though the precision is low it still manages to have a good EHR given the FCR.
