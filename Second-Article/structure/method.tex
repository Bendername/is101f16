...
\begin{table}[h]
  ...
  \begin{tabular}[c]{l|c|c|r}
    \hline
    sensor     & features & latency & duration \\ \hline
    GSR        & mean, median     & 2s & 4s \\ \hline
    EEG        & mean, median     & 2s & 4s \\ \hline
    Kinect     & mean, median     & 2s & 4s \\ \hline
    Heart rate & mean, median     & 2s & 4s \\ \hline
  \end{tabular}
  \caption{features}
  \label{tab:features}
\end{table}

\todo{fix table to show the correct features used}
