...
While there is still quite some debate in this area between researchers, and the exploration of this is beyond the scope of this paper an excellent overview is given by Law et. al \cite{attitudes_ux_measure}. 
Roto et al. \cite{what_is_ux} also states ``..No generally accepted overall measure of UX exists, but UX can be made assessable in many different ways.'' which precisely emphasize the problem with measuring UX. 
