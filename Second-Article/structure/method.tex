...
\begin{table}[H]
    ...
    \begin{tabularx}{\columnwidth}{cXc}
        ...
        \bottomrule
    \end{tabularx}
    %\caption{Timespan is in milliseconds, after stimuli. A indicates the feature can be used to classify arousal and V indicates the same for valence. Only features using electrodes accessible with the Emotiv EPOC were used.}
...
\todo{fix the shitty tables so that they dont take up as much space, and references are correct}
