...
The distribution in intro-/extraversion is the only one relevant to us, because it has an impact on how some physiological responses manifests it self like GSR\cite{extrovsintro}, the spread was AVG 29.49, SD 7.96. 
...
Our previous work\cite{9th_semester_project} showed promising results using descriptive statistics, e.g. mean, median and standard deviation. 
