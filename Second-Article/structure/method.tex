...
%    \hline
%    UP name         & description                                  & has seeded problem                                                                       \\ \hline
%    Add attachement & The user has to add an attachment to a mail. & The program ``hangs'' for 2 seconds three times, before the attachment can be completed. \\ \hline
%  \end{tabular}
