...
%TODO: desbribe Bruun, that he used both GSR and eye-tracking
...
%a number of fallacies are present in traditional approaches.
% We want to mitigate some of them, improving the usability testing procedure
% using phys sensors
