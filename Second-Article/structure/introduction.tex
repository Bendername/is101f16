...
GSR is}. As mentioned in Bruun et al.~\cite{LH-paper}, frustration is well-studied
...
% TODO: describe think-aloud
% TODO: mention research into think-aloud (to improve it) \cite{two_think_aloud_protocols_study}
...
% TODO: beskriv: Using Sensor Graphs to Stimulate Recall in Retrospective Think-aloud Protocols
% De gør lidt det samme som vi gør


%Previous and recent research related to usability testing methods suggests that
%a number of fallacies are present in traditional approaches. \cite{eval_effect}.
