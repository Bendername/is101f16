...
\todo{describe in a few lines what the evaluator effect is}
...
From the above mentioned related work, and recent research in the HCI body of
literature, suggests a need to revise traditional usability evaluation
approaches for various reasons. Current methods rely on subjective measurements
with focus on performance-based metrics. A current trend, as exemplified above,
is to introduce sensor, attempting to mitigate subjectivity and precision. While
it is not our aim to introduce new structured methods for conducting usability
evaluations, we do want to contribute with insigtful ideas on how sensors can be
introduced, and especially how multiple sensors can be used in conjuction to
improve results.
\todo{this is blah! Improve. Should say something about what our goal is/what
the uses-case for our results are. How can what we learn in this paper be used
in practice?}
