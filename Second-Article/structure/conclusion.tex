...
Resul for the other sensors in this regard, with EEG performing the worst. Choosing higher Nu-values quickly give rise to higher rates of false-positives, and
simultaneously higher event-hit rate. From this, we conclude that whether our results are good or not, depends on how they
are applied. We imagine a use-case where few usability problem are identified to a reasonable certainty, with a low Nu-value, used as
